...
// ILI9341 specific commands used by init()
...
static const uint8_t ILI9341_PWCTR6 = 0xFC;

static const uint8_t ILI9341_DELAY_FLAG = 0xFF;
// special marker for delay - command byte represents ms, length byte is an impossible value
#define ILI9341_DELAY(ms) ((uint8_t) ((ms) | 0x80)), ILI9341_DELAY_FLAG
