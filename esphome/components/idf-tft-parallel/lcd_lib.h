...
void ili9341_parallel_init(TFT_t * dev, int width, int height, int offsetx, int offsety);
void ili9341_parallel_draw_pixel(TFT_t * dev, uint16_t x, uint16_t y, uint16_t color);
void ili9341_parallel_draw_multi_pixels(TFT_t * dev, uint16_t x, uint16_t y, uint16_t size, uint16_t * colors);
void ili9341_parallel_display_on(TFT_t * dev);
void ili9341_parallel_display_off(TFT_t * dev);
